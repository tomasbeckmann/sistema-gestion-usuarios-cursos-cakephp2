			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="alert alert-info">
						<strong>Nota:</strong> Para cambiar la contraseña, usa el botón "Cambiar Contraseña" desde el
						listado de usuarios.
					</div>

					<div class="d-flex justify-content-between">
						<?php echo $this->Html->link('Cancelar', array('action' => 'admin_dashboard'), array('class' => 'btn btn-secondary')); ?>
						<?php echo $this->Form->submit('Actualizar Usuario', array('class' => 'btn btn-primary', 'div' => false)); ?>
					</div>
